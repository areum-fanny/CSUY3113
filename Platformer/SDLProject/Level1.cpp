...
#define LEVEL1_WATER_COUNT 22

unsigned int level1_data[] =
{

21,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,21,
21,12,12,12,12,12,12,12,12,12,12,12,12,12,14,14,14,12,12,12,12,12,12,12,12,21,
21,14,14,14,14,14,14,14,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,21,
21,12,12,12,12,12,12,12,12,12,14,14,14,14,12,12,12,12,12,14,14,14,14,14,14,21,
21,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,21,
21,12,12,12,14,14,14,14,14,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,21,
21,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,21,
21,14,14,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,21
};
...
void Level1::Initialize() {
    ...
    state.player->position = glm::vec3(1.5f, -4 , 0);
    ...
    state.key->position = glm::vec3(2, -1, 0);
    state.key->type = KEY;
    ...
    state.doors[0].position = glm::vec3(24, -1, 0);
    state.doors[1].textureID = Util::LoadTexture("door.png");
    state.doors[1].position = glm::vec3(24, -2, 0);
    ...
    //Water
    x = 3.0f;
    state.obstacles = new Entity[LEVEL1_WATER_COUNT];
    GLuint waterTextureID = Util::LoadTexture("water.png");
    for (int i = 0; i < LEVEL1_WATER_COUNT;i++) {
    ...
    state.enemies[0].enemylevel = ROUND1;
...
void Level1::Update(float deltaTime) {
    ...
    for (int i = 0; i < LEVEL1_ENEMY_COUNT;i++) {
        state.enemies[i].Update(deltaTime, &state.enemies[i], state.obstacles, LEVEL1_WATER_COUNT, state.map);
    }
